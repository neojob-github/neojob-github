...
## :fire: About me :fire:
<span style="color:#4AD263" size=7 face="Привет! Меня зовут Дмитрий, мне 21 год, и я программист на python!"><br>
...
<font color=#0099ff size=7 face="Эта страница была создана для того, чтобы помочь мне найти хорошую и интересную работу!"><br>
